...
/**
 * Return a list of .ini images parsed from the additional ini dir
 * @link http://www.php.net/manual/en/function.php-ini-scanned-files.php
 * @return string a comma-separated string of .ini images on success. Each comma is
 ...
 * use a PHP script to handle requests for missing images (using
 ...
 * </p>
 * <p>
 * If you use the wrong line ending characters when writing your images, you
 * might find that other applications that open those images will "look
 * funny".
 * </p>
 * <p>
 ...
 * mode if you are working with plain-text images and you use
 * \n to delimit your line endings in your script, but
 * expect your images to be readable with applications such as notepad. You
 * should use the 'b' in all other cases.
 * </p>
 * <p>
 * If you do not specify the 'b' flag when working with binary images, you
 * may experience strange problems with your data, including broken image
 * images and strange problems with \r\n characters.
 * </p>
 * <p>
 * For portability, it is strongly recommended that you always
 * use the 'b' flag when opening images with fopen.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Seeking (offset) is not supported with remote images.
 * Attempting to seek on non-local images may work with small offsets, but this
 ...
 * This is used for local images, not URLs.
 * </p>
...
/**
 * List images and directories inside the specified path
 ...
 * @return array an array containing the matched images/directories, an empty array
 ...
 * </p>
 * <p>
 * For local images, the specific return value is that of the
 ...
 * \\computername\share\filename to check images on
 * network shares.
 * </p>
 ...
 * </p>
 * <p>
 * This function returns false for images inaccessible due to safe mode restrictions. However these
 * images still can be included if
...
/**
 * Returns directory path used for temporary images
