...
/**
 * Returns an array with the names of included or required images
 * @link http://www.php.net/manual/en/function.get-included-files.php
 * @return array an array of the names of all images.
 * </p>
 * <p>
 * The script originally called is considered an "included file," so it will
 * be listed together with the images referenced by
 * include and family.
 * </p>
 * <p>
