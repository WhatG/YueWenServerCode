...
class Phar extends RecursiveDirectoryIterator implements RecursiveIterator, SeekableIterator, Traversable, Iterator, Countable, ArrayAccess {
	...
	/**
	 * Construct a phar archive from the images within a directory.
	 * @link http://www.php.net/manual/en/phar.buildfromdirectory.php
	 * @param base_dir string <p>
	 * The full or relative path to the directory that contains all images
	 * to add to the archive.
	 * </p>
	 * @param regex string[optional] <p>
	 * An optional pcre regular expression that is used to filter the
	 * list of images. Only file paths matching the regular expression
	...
	/**
	 * Compresses all images in the current Phar archive
	...
	/**
	 * Decompresses all images in the current Phar archive
	...
	/**
	 * Returns the number of entries (images) in the Phar archive
	 * @link http://www.php.net/manual/en/phar.count.php
	 * @return int The number of images contained within this phar, or 0 (the number zero)
	 * if none.
	 */
	 ...
	 * The name of a file or directory to extract, or an array of images/directories to extract
	 * </p>
	 * @param overwrite bool[optional] <p>
	 * Set to true to enable overwriting existing images
	 * </p>
	 * @return bool returns true on success, but it is better to check for thrown exception,
	 * and assume success if none is thrown.
	 */
...
class PharData extends RecursiveDirectoryIterator implements RecursiveIterator, SeekableIterator, Traversable, Iterator, Countable, ArrayAccess {
	...
	/**
	 * Construct a tar/zip archive from the images within a directory.
	...
	/**
	 * Compresses all images in the current tar/zip archive
	...
	/**
	 * Decompresses all images in the current zip archive
