 ...
 * information about which images have been served from the bytecode cache
 ...
 * the system cache (cached images) will be returned.
 * </p>
 ...
 * user cache will be cleared; otherwise, the system cache (cached images)
 * will be cleared.
 * </p>
...
/**
 * Get a binary dump of the given images and user variables
 * @link http://www.php.net/manual/en/function.apc-bin-dump.php
 * @param files array[optional] <p>
 * The images. Passing in &null; signals a dump of every entry, while
 ...
 * passing in array will dump nothing.
 * </p>
 * @return string a binary dump of the given images and user variables from the APC cache,
...
/**
 * Output a binary dump of cached images and user variables to a file
