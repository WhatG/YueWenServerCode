 ...
 * @param description array[optional] The data by which the sppol images will be filtered, array with following keys:<br>* username - username that created the job<br> * outq - qualified name for the output queue containing the spool file<br> * userdata - the user-supplied key data for the spool file<br>All keys are optional and can be provided together.
 * @param connection resource[optional] result of i5_connect
 * @return resource if OK, false if failed
 */
