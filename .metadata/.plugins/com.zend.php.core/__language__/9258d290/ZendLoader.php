<?php
/**
 * Checks the Zend Optimizer+ configuration to verify that it is configured to load encoded images
 * @return boolean Returns TRUE if the Guard Loader is configured to load encoded images. Returns FALSE if the Guard Loader is not configured to load encoded images.
 * @since 4.0
 */
